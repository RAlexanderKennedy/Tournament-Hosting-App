  ...
  <div>
     ...
     <form v-on:submit.prevent="addNewTournament">
         <div class="form-element">
             ...
             <input type="text" v-model="newTournament.name"/>
             </div>
         <div class="form-element">
             <label for="Start Date">Start Date:</label>
             <input type="date" v-model="newTournament.startDate"/>
             </div>     
         <div class="form-element">
             <label for="End Date">End Date:</label>
             <input type="date" v-model="newTournament.endDate"/>
             </div>
             <input type="submit" value="Save" />
             <input typpe="button" value="Cancel" v-on:click.prevent="resetForm" />
             </form>
  </div>
</template>
